...
#ifndef GAZEBO_ROS_POSITION_CONTROL_HH
#define GAZEBO_ROS_POSITION_CONTROL_HH
...
namespace gazebo {
  ...
  class GazeboRosPositionControl : public ModelPlugin {

    public: 
      GazeboRosPositionControl();
      ~GazeboRosPositionControl();
...
#endif /* end of include guard: GAZEBO_ROS_POSITION_CONTROL_HH */
